export type PageId = "overview" | "publish" | "confirmation" | "tasks" | "agents" | "users" | "audit" | "governance"

export type PageRefreshTarget = "tasks" | "humanSubtasks" | "agents" | "assignableUsers" | "users"

const ADMIN_ONLY_PAGES = new Set<PageId>(["agents", "users", "audit", "governance"])
